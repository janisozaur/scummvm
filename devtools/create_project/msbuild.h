...
protected:
	...
	void outputProjectSettings(std::ofstream &project, const std::string &name, const BuildSetup &setup, bool isRelease, MSVC_Architecture arch, std::string configuration);
	...
	void createBuildProp(const BuildSetup &setup, bool isRelease, MSVC_Architecture arch, std::string configuration) override;
